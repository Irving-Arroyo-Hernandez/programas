...
public class Local {
   ...
   alumno alumno1 = new alumno(0,0,"",0,"","","");
   alumno1.setId_alumno(1);
   alumno1.setNombre("Luis");
   alumno1.setApellido_p("Gomez");
   alumno1.setApellido_m("Ruiz");
   
  alumno1.setNumero(12345);
   alumno1.setSexo("M");
   
   alumno alumno2 = new alumno(0,0,"",0,"","","");
   alumno2.setId_alumno(2);
   ...
   alumno alumno3 = new alumno(0,0,"",0,"","","");
   alumno3.setId_alumno(3);
   ...
   prestamo3.setLibros(listaLibros3);
        ...
        System.out.println("Irving Antonio Arroyo Hernandez");
}
